...
/*** TO BE DONE 8.0 START ***/
    ...
    create_listening_socket(port_as_str); 		// crea il socket con la funzione a riga 24
	drop_privileges();							// drop root privileges
...
/*** TO BE DONE 8.0 START ***/
	...
	// da manuale: int pthread_create(pthread_t *restrict thread, const pthread_attr_t *restrict attr, 
