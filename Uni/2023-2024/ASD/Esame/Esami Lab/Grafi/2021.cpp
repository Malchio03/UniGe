...
/* Calcola e restituisce il vertice (o un vertice nel caso ce ne siano diversi con valore uguale)
   avente grado uscente minimo (ossia il vertice avente minimo numero di archi uscenti) */
