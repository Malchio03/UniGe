...
// window
const char* window_title = "01b - texture files";
...
const char* ball_texture = "../texture_ball.png";

// paddle
const sf::Vector2f paddle_initial_size = {100.0, 16.0};
const char* paddle_texture = "../texture_paddle.png";
...
Ball::Ball ()
{
    ...
    pos = {ball_px, ball_py};
    texture = sf::Texture (ball_texture);
}
...
Paddle::Paddle ()
{
    ...
    texture = sf::Texture (paddle_texture);
}
