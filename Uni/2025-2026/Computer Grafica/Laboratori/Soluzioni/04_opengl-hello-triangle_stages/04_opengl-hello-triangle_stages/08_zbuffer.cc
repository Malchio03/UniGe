    ...
    void load ()
    {
        ...
        points = {
           ...
           -0.5,-0.5, 0.0, // blue, bottom left
            ...
            0.7, 0.5, 0.0, // white, top right
            0.8, 0.8, 0.8,

            0.0, 0.3, 0.1, // solid blue, behind
            0.0, 0.0, 0.8,

            0.9,-0.3, 0.1, // solid blue, behind
            0.0, 0.0, 0.8,
        ...
        // 4 faces, 3 indices per face, CCW order
        indices = {
            0, 3, 1,
            1, 3, 2,
            1, 2, 4,
...
int main()
{
    ...
    // face culling: one side of the faces is optimized out.
    // alternate between back and front, recompile and run
    // swap two indices in one or two faces, recompile and run

    glEnable (GL_CULL_FACE);
    glCullFace (GL_BACK);
    //glCullFace (GL_FRONT);

    // depth testing, using the default zbuffer, and the default condition
    // two new solid color triangles have been added, with separate vertices
    // they should be behind previous ones, but they are drawn last
    // see what happens with and without depth testing
