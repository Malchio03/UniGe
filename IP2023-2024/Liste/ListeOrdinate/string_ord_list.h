...
// - se la lista ordinata l è vuota solleva un'eccezione con messaggio di tipo string // - se l'indice i è invalido solleva un'eccezione con messaggio di tipo string
// NB: nessuna variazione rispetto alla versione per liste non ordinate
...
// restituisce true se le due liste contengono le stesse stringhe (con la stessa molteplicità) // false altrimenti
...
// è la somma del numero delle sue occorrenze nelle due liste l1 e l
